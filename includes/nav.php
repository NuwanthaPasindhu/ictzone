  ...
  <a class="nav-link <?php if($active =="resources")echo"active";?> " aria-current="page" href="./resources.php">Resources</a>
              ...
              <li class="nav-item">
  <a class="nav-link <?php if($active =="about")echo"active";?> " aria-current="page" href="./mails/about.php">AboutUs</a>
              </li>
          <li class="nav-item">
  <a class="nav-link <?php if($active =="about")echo"active";?> " aria-current="page" href="./users">Login</a>
              </li>
